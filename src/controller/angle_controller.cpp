...
float theta = 0.0; // Beginwaarden OMEGA, hoeksnelheid, en hoek in rad met random getal
float avg_alpha = 0.0;
float avg_omega = 0.0;
 ...
 */
 void angle_controller(MotorSettings& motorData, MotorForce& motorForce,
	...
	avg_omega = (avg_omega +  degreesOfFreedomData.gyroData.omega)/2;   //Neem het gemiddelde van 2 metingen om grote afwijkingen te voorkomen
	...
	float F_gyro = Kp_gyro * error_gyro + Kd_gyro * d_error_gyro/DELTA_t + Ki_gyro * error_gyro_som *DELTA_t;
