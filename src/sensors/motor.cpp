...
void convertForceToPWM(MotorSettings& data, MotorForce& motorForce) {
  ...
  if(motorForce.motor1Force > 0.0){
    ...
    data.motorPWMSpeed1 = round(-1*(1892.2*motorForce.motor1Force ) - 43.784);
  }else{
  ...
  if(motorForce.motor2Force > 0.0){
    ...
    data.motorPWMSpeed2 = round(-1*(2041.3*motorForce.motor2Force) - 34.483);
  }else{
  ...
  if(motorForce.motor3Force > 0.0){
    ...
    data.motorPWMSpeed3 = round(-1*(1990.5*motorForce.motor3Force) - 23.693);
  }else{
